...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--patch_size', default=(128, 128, 16), help='Size of the patches extracted from the image')
        ...
        parser.add_argument('--batch_size', type=int, default=8, help='batch size, depends on your machine')
